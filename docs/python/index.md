...
- [django-grappelli](https://github.com/sehmaschine/django-grappelli) - Django 管理界面的爵士皮肤。
...
_数据结构、算法和设计模式的 Python 实现。另请参阅 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms)._
...
_[ASGI](https://asgi.readthedocs.io/en/latest/)- 兼容 Web 服务器_
...
- [hypercorn](https://github.com/pgjones/hypercorn) - 基于 Hyper 库并受 Gunicorn 启发的 ASGI 和 WSGI 服务器.

## 异步编程

_用于异步、并发和并行执行的库。另请参阅 [awesome-asyncio](https://github.com/timofurrer/awesome-asyncio)._
...
- [uvloop](https://github.com/MagicStack/uvloop) - 超快异步事件循环.
- [eventlet](https://github.com/eventlet/eventlet) - 支持 WSGI 的异步框架.
- [gevent](https://github.com/gevent/gevent) - 使用 greenlet 的基于协程的 Python 网络库. [greenlet](https://github.com/python-greenlet/greenlet).
...
- 音频
  ...
  - [kapre](https://github.com/keunwoochoi/kapre) - 音频预处理器。
  ...
  - [mingus](http://bspaans.github.io/python-mingus/) - 高级音乐理论和记谱包，具有 MIDI 文件和播放支持。
  - [pyaudioanalysis](https://github.com/tyiannak/pyAudioAnalysis) - 音频特征提取、分类、分割和应用。
  - [pydub](https://github.com/jiaaro/pydub) - 使用简单易用的高级界面操作音频。
  - [timeside](https://github.com/Parisson/TimeSide) - 开放的网络音频处理框架。
- Metadata
  - [beets](https://github.com/beetbox/beets) - 音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器.
...
- OAuth
  - [authlib](https://github.com/lepture/authlib) - JavaScript 对象签名和加密草案实现。
  - [django-allauth](https://github.com/pennersr/django-allauth) - “正常工作”的 Django 身份验证应用程序
  - [django-oauth-toolkit](https://github.com/jazzband/django-oauth-toolkit) - 适用于 Django 的 OAuth 2 好东西。
  - [oauthlib](https://github.com/oauthlib/oauthlib) - OAuth 请求签名逻辑的通用且彻底的实现。
- JWT
...
- [bitbake](https://github.com/openembedded/bitbake) - 用于嵌入式 Linux 的类似 make 的构建工具。
...
- [scons](https://github.com/SCons/scons) - 一个软件构建工具

## 内置类增强

_用于增强 Python 内置类的库._

- [attrs](https://github.com/python-attrs/attrs) - 替换类定义中的 **init** 、 **eq** 、 **repr** 等样板文件.
...
- [wagtail](https://github.com/wagtail/wagtail) - Django 内容管理系统。
...
- [errbot](https://github.com/errbotio/errbot/) - 实现 ChatOps 的最简单且最受欢迎的聊天机器人。

## 代码分析

_静态分析、linter 和代码质量检查工具。另请参阅 [awesome-static-analysis](https://github.com/mre/awesome-static-analysis)._
...
_用于可视化数据的库。另请参阅 [awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization)._
...
_传统的全栈 Web 框架。另请参阅[RESTful API](https://github.com/vinta/awesome-python#restful-api)._
...
_用于使用 WebSocket 的库。_

- [autobahn-python](https://github.com/crossbario/autobahn-python) - Twisted 和 [asyncio](https://docs.python.org/3/library/asyncio.html)上用于 Python 的 WebSocket 和 WAMP.
...
- [gunicorn](https://github.com/benoitc/gunicorn) - Pre-forked，从 Ruby 的 Unicorn 项目移植。
...
- [werkzeug](https://github.com/pallets/werkzeug) - Python 的 WSGI 实用程序库，为 Flask 提供支持，并且可以轻松嵌入到您自己的项目中。
